...
$tinybrowser['path']['image'] = '/uploads/filemanager/images/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = '/uploads/media/'; // Media files location
$tinybrowser['path']['file'] = '/uploads/filemanager/files/'; // Other files location

$tinybrowser['thumbdir'] = 'thumbs'; // Thumbnail dirrectiry
$tinybrowser['thumbprefix'] = 'thumb_'; // Thumbnail prefix
...
$tinybrowser['thumbsize'] = (CONF_FILEMANAGER_THUMBNAIL_WIDTH > CONF_FILEMANAGER_THUMBNAIL_HEIGHT) ? CONF_FILEMANAGER_THUMBNAIL_WIDTH : CONF_FILEMANAGER_THUMBNAIL_HEIGHT;
