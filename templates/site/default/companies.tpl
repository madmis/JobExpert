		...
		<table class="mainBodyTable" cellspacing="0">
			<tr>
				<th colspan="2" class="CompanyName">
						<a href="{$chpu->createChpuUrl("`$smarty.const.CONF_SCRIPT_URL`index.php?do=companies&amp;action=detail&amp;id=`$company.tId`")}" title="{$company.company_name|escape}">
			...
			<tr>
				<td class="last AlignRight" colspan="2">
					<a href="{$chpu->createChpuUrl("`$smarty.const.CONF_SCRIPT_URL`index.php?do=companies&amp;action=detail&amp;id=`$company.tId`")}" title="{$smarty.const.SITE_COMPANY_VACANCY}&nbsp;{$company.company_name|escape}">{$smarty.const.SITE_COMPANY_VACANCY}...</a>
				</td>
			</tr>
		</table>
		{/foreach}
