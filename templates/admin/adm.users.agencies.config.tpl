<form action="{$smarty.const.CONF_ADMIN_FILE}?m=users&amp;s=agencies&amp;action=config" method="post" enctype="multipart/form-data">
<table style="width: 100%;" class="data_table" cellspacing="5" cellpadding="5">
	<tr>
		...
		<td>
			<input type="text" name="admperpage" size="5" value="{$smarty.const.CONF_AGENCIES_STRINGS_PERPAGE_ADMIN_PANEL}" class="text">
		</td>
	...
	<tr>
		...
		<td>
			<input type="text" name="perpage" size="5" value="{$smarty.const.CONF_AGENCIES_PERPAGE}" class="text">
		</td>
		{*<td style="text-align: center;">
	...
	<tr>
		...
		<td><input type="checkbox" name="with_logo" {if $smarty.const.CONF_AGENCIES_SHOW_ONLY_WITH_LOGO}checked{/if}></td>
		{*<td style="text-align: center;">
	...
	<tr>
		...
		<td><input type="checkbox" name="delete_logo" {if $smarty.const.CONF_AGENCIES_DELETE_LOGO}checked{/if}></td>
		{*<td style="text-align: center;">
	...
	<tr>
		...
		<td>
			...
			{else}
				<input type="checkbox" name="html" {if $smarty.const.CONF_AGENCIES_USE_VISUAL_EDITOR}checked{/if}>
			{/if}
		</td>
		{*<td style="text-align: center;">
	...
	<tr>
		...
		<td>
			<input type="checkbox" name="show_main_logo" {if $smarty.const.CONF_AGENCIES_SHOW_MAIN_LOGO}checked{/if}>
		</td>
		{*<td style="text-align: center;">
	...
	<tr>
		...
		<td>
			{if $smarty.const.CONF_COMPANIES_SHOW_MAIN_LOGO}
				<input type="text" name="logo_qty" size="5" value="{$smarty.const.CONF_AGENCIES_SHOW_MAIN_LOGO_QTY}" class="text">
			{else}
				<input type="text" name="logo_qty" size="5" value="{$smarty.const.CONF_AGENCIES_SHOW_MAIN_LOGO_QTY}" class="text" disabled>
			{/if}
		</td>
		{*<td style="text-align: center;">
