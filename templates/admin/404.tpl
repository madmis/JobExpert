				...
				<td>
					<p class="p_5 p_bold">{$smarty.const.ERROR_404_RECOMMENDATIONS}:</p>
   					<ul type="disc" style="margin: 0px 0px 20px 0px;">
   						...
   						<li>{$smarty.const.ERROR_404_RECOMMENDATIONS_BACK_TO} <a href="{$smarty.const.CONF_SCRIPT_URL}admin.php">{$smarty.const.ERROR_404_RECOMMENDATIONS_BACK_TO_MAIN_PAGE_LINK}</a> {$smarty.const.ERROR_404_RECOMMENDATIONS_BACK_TO_MAIN_PAGE}</li>
   					</ul>
				</td>
			</tr>
			<tr>
				<td style="background-color: #CC3333; color: #FFFFFF; font-weight: bold; font-size: 10pt; text-align: center; padding: 5px;">
					&copy; SD-Group {$smarty.now|date_format:"%Y"}-{$smarty.now|date_format:"%Y"+5}
				</td>
			</tr>
		</table>
	</body>
