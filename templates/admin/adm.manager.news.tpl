<p class="sub_menu"><span class="colorbox_help" id="HELP_ADMIN_MANAGER_NEWS"><img src="{$smarty.const.TEMPLATE_PATH_ADMIN}images/actions/help.png" alt="{$smarty.const.FORM_IMG_HELP}"></span></p>

{if $errors}{include file="adm.errors.message.tpl"}{/if}

{* Добавление новостей *}
{if $actions.add}
	{include file="adm.manager.news.add.tpl"}
{* Редактирование новостей *}
{elseif $actions.edit}
	{include file="adm.manager.news.edit.tpl"}
{* Архив новостей *}
{elseif $actions.archived}
	{include file="adm.manager.news.archived.tpl"}
{* Новости ожидающие редактирования *}
{elseif $actions.correction}
	{include file="adm.manager.news.correction.tpl"}
{* Модерация новостей *}
{elseif $actions.moderate}
	{include file="adm.manager.news.moderate.tpl"}
{* Настройки новостей *}
{elseif $actions.config}
	{include file="adm.manager.news.config.tpl"}
{* Комментарии к новостям *}
{elseif $actions.comments}
	{include file="adm.manager.news.comments.list.tpl"}
{* Список новостей *}
{else}
	...
	<table style="width: 100%; border-spacing: 0px;" class="otbor_table">
		<thead class="otbor_head" id="news">
			<tr><td>{$smarty.const.TABLE_FORM_SELECTION}</td></tr>
		</thead>
		<tbody>
			<tr>
				<td class="alignLeft" style="width: 100%;">
					<table style="width: 100%;" class="hidden_table" id="news_otbor">
