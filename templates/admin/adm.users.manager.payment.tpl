<form action="{$smarty.const.CONF_ADMIN_FILE}?m=users&amp;s=manager&amp;action=payment" method="post" enctype="multipart/form-data">
<table width="100%" cellspacing="5" cellpadding="3">
	<thead class="data_head">
		<tr>
			<td>
				<a href="{$smarty.const.CONF_ADMIN_FILE}?m=users&amp;s=manager&amp;action=payment&amp;order=users.email&amp;by={if $order['users.email'] eq 'asc'}desc{else}asc{/if}" class="white">
			...
			<td>
				<a href="{$smarty.const.CONF_ADMIN_FILE}?m=users&amp;s=manager&amp;action=payment&amp;order=conf_users.user_type&amp;by={if $order['conf_users.user_type'] eq 'asc'}desc{else}asc{/if}" class="white">
			...
			<td>
				<a href="{$smarty.const.CONF_ADMIN_FILE}?m=users&amp;s=manager&amp;action=payment&amp;order=conf_users.user_group&amp;by={if $order['conf_users.user_group'] eq 'asc'}desc{else}asc{/if}" class="white">
			...
			<td>
				<a href="{$smarty.const.CONF_ADMIN_FILE}?m=users&amp;s=manager&amp;action=payment&amp;order=users.reg_datetime&amp;by={if $order['users.reg_datetime'] eq 'asc'}desc{else}asc{/if}" class="white">
